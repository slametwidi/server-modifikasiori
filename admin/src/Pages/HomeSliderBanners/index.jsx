                                ...
                                <tbody>
                                    <tr className='odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200'>
                                        ...
                                        <td className="py-2 w-[50%]">
                                            <div className='flex items-center gap-4'>
                                                <div className='img w-[300px] h-[100px] rounded-md overflow-hidden group'>
                                                    <Link to='/'><img className='w-full h-full group-hover:scale-105 transition-all' src='/slide1.png'/></Link>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className='odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200'>
                                        ...
                                        <td className="py-2 w-[50%]">
                                            <div className='flex items-center gap-4'>
                                                <div className='img w-[300px] h-[100px] rounded-md overflow-hidden group'>
                                                    <Link to='/'><img className='w-full h-full group-hover:scale-105 transition-all' src='/slide2.jpg'/></Link>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-2 text-center w-[10%]">
